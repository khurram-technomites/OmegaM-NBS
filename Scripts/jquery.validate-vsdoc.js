 ...
 * terms; or (ii) using the files as included with a Microsoft car subject
 * to that car's license terms. Microsoft reserves all other rights to the
...
* standard jQuery library for all carion use.
*
