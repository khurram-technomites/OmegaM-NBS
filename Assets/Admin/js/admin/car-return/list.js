				...
				},
			 {
			 	...
			 	render: function (data, type, full, meta) {
			 		...
			 		if (typeof status[data] === 'undefined') {
			 			return '<a  href="javascript:" class="label label-lg label-light-dark label-inline" onclick="OpenModelPopup(this,\'/Admin/CarReturn/StatusChange/' + full[5] + '\',true)">' + data + '</a>';
			 		}
			 		return '<a href="javascript:" class="label label-lg ' + status[data].class + ' label-inline" onclick="OpenModelPopup(this,\'/Admin/CarReturn/StatusChange/' + full[4] + '\',true)">' + data + ' </a>';
			 ...
			 },
				 {
				 	...
				 	orderable: false,
				 	render: function (data, type, full, meta) {
				 		return '<a type="button" class="btn btn-bg-secondary btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/CarReturn/Details/' + data + '\')" title="View">' +
