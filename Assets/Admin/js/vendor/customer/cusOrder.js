...
var KTDatatablesBasicScrollable = function () {
    ...
    var initTable1 = function () {
        ...
        table1 = table.DataTable({
            ...
            //        var actions = '';
            //        actions += '<a class="btn btn-secondary btn-sm mr-1" hidden href="/Admin/Order/Details?id=' + full[5] + '">' +
            ...
            //},
                ...
                orderable: false,
                    ...
                    var actions = '';
                    actions += '<a class="btn btn-secondary btn-sm mr-1" href="/Vendor/Order/Details?id=' + data + '">' +
                        '<i class="fa fa-folder-open"></i> Details' +
                        '</a> ';
                    return actions;
                },
            ...
            
            {
                ...
                render: function (data, type, full, meta) {
                    ...
                    if (typeof status[data] === 'undefined') {
                        return '<a  href="javascript:" class="label label-lg label-light-dark label-inline" onclick="OpenModelPopup(this,\'/Vendor/Customer/StatusChange/' + full[4] + '\',true)">' + data + '</a>';
                    }
                    return '<a href="javascript:" class="label label-lg ' + status[data].class + ' label-inline" onclick="OpenModelPopup(this,\'/Vendor/Customer/StatusChange/' + full[4]+ '\',true)">' + data + ' </a>';
...
jQuery(document).ready(function () {
    ...
    $("#btnSearch").on("click", function () {
        ...
        $.ajax({
            url: "/Vendor/Customer/CustomerBookingList",
            type: 'POST',
            data: {
                sd: $('#fromDate').val(),
                ed: $('#toDate').val(),
