...
function BindPackages() {
    ...
    $.ajax({
        url: '/Vendor/Car/GetCarPackages/' + GetURLParameter(),
        type: 'GET',
        success: function (response) {
            if (response.success) {
                var html = "";
...
function BindDocument() {
    ...
    $.ajax({
        url: '/Vendor/Car/GetDocuments/' + GetURLParameter(),
        type: 'GET',
        success: function (response) {
            if (response.success) {
                var html = "";
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.success) {
                ...
                $('.car-inspectionse').html('No inspections!');
            }
        }
    });
}
...
function SaveNewCarDocs() {
    ...
    $.ajax({
        url: '/Vendor/Car/CreateDocuments/',
        type: 'POST',
        processData: false,
        contentType: false,
        data: data,
...
function SaveNewCarInspection() {
    ...
    $.ajax({
        url: '/Vendor/CarInspection/CreateInspection/',
        type: 'POST',
        processData: false,
        contentType: false,
        data: data,
...
function MyNewFeature(e) {
    ...
    if ($(e).prop('checked')) {
        ...
        $.ajax({
            url: '/Vendor/CarFeature/Delete/' + $(e).attr('FeatureID'),
            type: 'POST',
            data: {
                "__RequestVerificationToken":
					$("input[name=__RequestVerificationToken]").val()
...
function getCarModelsByCarMakeID(CarMakeID) {
    ...
    $.ajax({
        ...
        url: '/Vendor/Car/GetCarModelsByCarMakeID',
        async: true,
...
function DeleteDocument(element, record) {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Vendor/Car/DeleteCarDocument/' + record,
                type: 'POST',
                data: {
                    "__RequestVerificationToken":
						$("input[name=__RequestVerificationToken]").val()
...
function DeleteInspection(element, record) {
    swal.fire({
        ...
        if (result.value) {
            ...
            $(this).addClass('spinner spinner-dark spinner-right');
            $.ajax({
                url: '/Vendor/CarInspection/DeleteCarInspection/' + record,
                type: 'POST',
                data: {
                    "__RequestVerificationToken":
                        $("input[name=__RequestVerificationToken]").val()
            ...
            if (response.success) {
                ...
                $('.car-category input[type="checkbox"]').change(function () {
                    ...
                    if ($(chkcategory).prop('checked')) {
                        ...
                        $.ajax({
                            url: '/Vendor/CarCategory/Delete/' + $(chkcategory).attr('carCategoryId'),
                            type: 'POST',
                            data: {
                                "__RequestVerificationToken":
									$("input[name=__RequestVerificationToken]").val()
...
function BindCarFeatures() {
    ...
    $.ajax({
        url: '/Vendor/CarFeature/GetCarFeatures/' + GetURLParameter(),
        type: 'GET',
        success: function (response) {
            if (response.success) {
                $('.car-features').html('');
                ...
                $('.car-feature input[type="checkbox"]').change(function () {
                    ...
                    if ($(chkfeature).prop('checked')) {
                        ...
                        $.ajax({
                            url: '/Vendor/CarFeature/Delete/' + $(chkfeature).attr('FeatureID'),
                            type: 'POST',
                            data: {
                                "__RequestVerificationToken":
									$("input[name=__RequestVerificationToken]").val()
