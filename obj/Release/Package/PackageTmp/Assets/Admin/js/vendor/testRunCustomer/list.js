        ...
        table1 = table.DataTable({
            ...
            columnDefs: [{
                ...
                render: function (data, type, full, meta) {
                    ...
                    actions += '<button type = "button" class="btn btn-bg-secondary btn-sm mr-1" onclick = "OpenModelPopup(this,\'/Vendor/TestRunCustomer/Details/' + data + '\')" title="Details" > <i class="fa fa-folder-open"></i>Details</button > ';
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        var href = '/Vendor/Property/edit/' + split[1] ;
                        //if (split[4] == "Property") {
