			...
			columnDefs: [
				...
				},
				{
					...
					render: function (data, type, full, meta) {
						...
						actions += '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Vendor/Car/EditInsurance/' + data[1] + '\',true)">' +
							'<i class="fa fa-pen"></i>' +
							'</button> ' +
							'<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Vendor/Car/InsuranceDetails/' + data[1] + '\')" title="View">' +
...
function BindInsurance() {
	...
	$.ajax({
		url: '/Vendor/Car/GetInsurances/' + GetURLParameter(),
		type: 'GET',
