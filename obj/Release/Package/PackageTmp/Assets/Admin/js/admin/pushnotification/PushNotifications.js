...
function getHtmlizeNotification(v) {
    ...
    if (!v.IsRead) {
        ...
        HTMLNotification += '</a>';
        HTMLNotification += '</div>';
        HTMLNotification += '<i class="fa fa-circle notification-read-circle pl-19 cursor-pointer" onclick="IsRead(' + v.ID + ',this);" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" float="right" data-content="mark as read"></i>';
        HTMLNotification += '</div>';
    } else {
        ...
        HTMLNotification += '</a>';
        HTMLNotification += '</div>';
        HTMLNotification += '<i class="fa fa-circle-notch notification-read-circle pl-19 cursor-pointer" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Read"></i>';
        HTMLNotification += '</div>';
    }
