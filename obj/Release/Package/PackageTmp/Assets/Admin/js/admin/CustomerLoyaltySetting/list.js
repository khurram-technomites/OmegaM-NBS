        ...
        table1 = table.DataTable({
            ...
            columnDefs: [
                ...
                render: function (data, type, full, meta) {
                    ...
                    actions += '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/CustomerLoyaltySetting/Edit/' + data[1] + '\',true)">' +
									'<i class="fa fa-pen"></i>' +
								'</button> ' +
                                '<button class="btn btn-secondary btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/CustomerLoyaltySetting/Details/' + data[1] + '\',true)">' +
...
function Delete(element, record) {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Admin/CustomerLoyaltySetting/Delete/' + record,
                type: 'POST',
                data: {
...
function Activate(element, record) {
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Admin/CustomerLoyaltySetting/Activate/' + record,
                type: 'Get',
