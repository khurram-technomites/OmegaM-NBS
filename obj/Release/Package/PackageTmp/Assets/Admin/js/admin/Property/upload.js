...
jQuery(document).ready(function () {
	...
	$("#UploadProduct").submit(function () {
		
		var vendorId = $("#VendorID").val();
		Swal.fire({
			title: "Uploading properties in bulk",
			...
			onOpen: function () {
				...
				$.ajax({
					url: '/Admin/Property/BulkUpload?connectionId=' + connectionId + '&' + 'VendorID=' + vendorId,
					type: 'Post',
					processData: false,
					contentType: false,
					data: data,
			...
			if (result.dismiss === "timer") {
				console.log("Properties upload completed!");
			}
		})
