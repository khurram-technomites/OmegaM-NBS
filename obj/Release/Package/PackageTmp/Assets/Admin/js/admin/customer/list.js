        ...
        table1 = table.DataTable({
            ...
            columnDefs: [{
                ...
                render: function (data, type, full, meta) {
                    ...
                    actions += '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" style="float: left;" onclick="OpenModelPopup(this,\'/Admin/Customer/Edit/' + data[1] + '\',true)">' +
                        '<i class="fa fa-pen"></i>' +
                        '</button> ' +
                        '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" style="float: left;" onclick="OpenModelPopup(this,\'/Admin/Customer/Details/' + data[1] + '\')" title="View">' +
                        '<i class="fa fa-folder-open"></i>' +
                        '</button> ' +
                        '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" style="float: left;" onclick="Delete(this,' + data[1] + ')"><i class="fa fa-trash"></i></button>';
...
function Delete(element, record) {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Admin/Customer/Delete/' + record,
                type: 'POST',
                data: {
...
function Activate(element, record) {
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Admin/Customer/Activate/' + record,
                type: 'Get',
