$(document).ready(function () {
    $('#Nationality').html(NationalitiesOption);
    
    $('#comment_form').submit(function () {
        var form = $(this);
        $('#BtnComment_form').html('<span class="fa fa-spinner fa-spin"></span> Apply Now').attr('disabled', true);
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    $('#BtnComment_form').html('Apply Now').attr('disabled', false);
                } else {
