            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        actions += '<a  class="btn btn-bg-secondary btn-icon btn-sm mr-1" href="/Admin/Vendor/Edit/' + data[1] + '">' +
                            '<i class="fa fa-pen"></i>' +
                            '</a> ' +
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        actions += '<button class="btn btn-bg-secondary" onclick="OpenModelPopup(this,\'/Admin/Vendor/VendorTransactionHistory?VendorID=' + data + '\');">' +
