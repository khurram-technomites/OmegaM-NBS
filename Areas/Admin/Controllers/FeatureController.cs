...
namespace NowBuySell.Web.Areas.Admin.Controllers
{
    ...
    public class FeatureController : Controller
    {
        ...
        public FeatureController(IFeatureService featureService, INotificationReceiverService notificationReceiverService, INotificationService notificationService)
        {
        ...
        {
            var feature = _featureService.GetAllCarFeature();
                ...
                if (_featureService.CreateFeature(feature, ref message))
                {
                    return Json(new
                    {
                        ...
                        data = new
                        {
                            ...
                            Name = feature.Name,
                            Image = feature.Image,
                            Category = feature.Image + "|" + feature.Name,
        ...
        public ActionResult Delete(long? id)
        {
            ...
            Feature type = _featureService.GetFeature((Int16)id);
            if (type == null)
            {
                return HttpNotFound();
            }
                    ...
                    if (filename.EndsWith(".xlsx"))
                    {
                        ...
                        try
                        {
                            ...
                            foreach (var item in tenants)
                            {
                                ...
                                {
                                    if (_featureService.PostExcelData(item.Feature, item.FeatureAr, "Car"))
                                    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult CarFeatureReport()
        {
            var getAllMake = _featureService.GetAllCarFeature().ToList();
