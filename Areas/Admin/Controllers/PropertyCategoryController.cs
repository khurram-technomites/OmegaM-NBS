...
namespace NowBuySell.Web.Areas.Admin.Controllers
{
    ...
    public class PropertyCategoryController : Controller
    {
        ...
        public PropertyCategoryController(ICategoryService categoryService)
        {
            _categoryService = categoryService;
        }
        // GET: Admin/PropertyCategory
        ...
        {
            var categories = _categoryService.GetPropertyCategories("All");
        ...
        public ActionResult CategoriesReport()
        {
            ...
            var getAllCatagories = _categoryService.GetPropertyCategories("All").ToList();
        ...
        public ActionResult Create(string CategoryName, string CategoryNameAr, string Description, int Position, string DescriptionAR, string Slug, bool IsDefault, string For, int type)
        {
            try
            {
        ...
        [HttpPost]
        //[ValidateAntiForgeryToken]
        public ActionResult Edit(long id, string CategoryName, string CategoryNameAr, int Position, string Description, string DescriptionAR, string Slug, bool IsDefault, string For, string type, string PropertyType)
        {
            try
            {
                string message = string.Empty;
            ...
            if (_categoryService.UpdateCategory(ref category, ref message))
            {
                ...
                return Json(new
                {
                    ...
                    data = new
                    {
                        ...
                        Position = category.Position,
                        Category = category.Icon + "|" + category.Image + "|" + category.CategoryName,
                        Type = category.ForSale + "|" + category.ForRent,
                        //IsParentCategoryDeleted = category.IsParentCategoryDeleted.HasValue ? category.IsParentCategoryDeleted.Value.ToString() : bool.FalseString,
                        IsActive = category.IsActive.HasValue ? category.IsActive.Value.ToString() : bool.FalseString
